...
console.log(`[Email] FROM: ${FROM_EMAIL} | FRONTEND_URL: ${FRONTEND_URL} | DEV_MODE: ${IS_DEV_MODE} | API_KEY_SET: ${!!RESEND_API_KEY}`);
...
async function resendSend(payload: {
  ...
  if (!RESEND_API_KEY) {
    console.log(`[Email] No RESEND_API_KEY — console fallback: To: ${payload.to} | Subject: ${payload.subject}`);
    return;
  }
