...
const Dashboard = () => {
  ...
  return (
    <div id="src_pages_Dashboard_k9cg" className="relative min-h-screen py-6 px-2 md:px-12 flex flex-col overflow-x-hidden" style={{fontFamily:'Inter, system-ui, sans-serif'}}>
      ...
      <div id="src_pages_Dashboard_zz0w" className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <section id="dashboard_brushsteel_wrap" className="dashboard-wrapper backdrop-blur-md bg-sectionBg rounded-3xl px-4 sm:px-6 lg:px-10 py-8 md:py-12 border border-borderGray shadow-steel">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 id="src_pages_Dashboard_dd5v" className="text-4xl sm:text-5xl tracking-tight font-extrabold brushsteel-text drop-shadow-lg mb-2" style={{letterSpacing:'-0.02em'}}>
          ...
          <div id="src_pages_Dashboard_ok2t" className="grid lg:grid-cols-3 gap-8 mb-12">
