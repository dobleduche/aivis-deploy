        ...
        <div id="src_components_Navbar_6crv" className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-6">
            <Link to="/" className="flex items-center space-x-3">
              ...
              />
              <span id="src_components_Navbar_3ccy" className="text-xl font-bold text-gray-900 dark:text-white">AiVis</span>
            </Link>
            
            {/* Back to Home link when on dashboard routes */}
            {isOnDashboardRoute && (
              <Link
                to="/"
                className="flex items-center gap-1.5 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm font-medium transition-colors"
              >
          ...
          <div id="src_components_Navbar_u1bf" className="flex items-center space-x-4">
            <button
